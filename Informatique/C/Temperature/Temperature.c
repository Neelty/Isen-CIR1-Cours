...
int main(int argc, char *argv[]) {
  ...
  scanf("%lf", &tf); /* Get l'entrée clavier de l'utilisateur, et place la valeur 'dans' tf (type de l'entrée, caster par le '%lf') */
  printf("%lf\n", (tf+459.67)*(5.0/9));/* Print notre valeur obtenue, après notre transformation */

  return 0; /*  On marque la fin de notre programme */
